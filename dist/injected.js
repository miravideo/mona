if (window['Violentmonkey:ZTtqcBBVZ8w='] !== 1) { /* eslint-disable no-unused-vars */
...
function getXhrInjection() {
  try {
    const quotedKey = `"${"Violentmonkey:ZTtqcBBVZ8w="}"`; // Accessing document.cookie may throw due to CSP sandbox
...
const INIT_FUNC_NAME = "Violentmonkey:ZTtqcBBVZ8w=";
