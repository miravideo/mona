if (window['Violentmonkey:xWD1Be9nJAY='] !== 1) { /* eslint-disable no-unused-vars */
...
function getXhrInjection() {
  try {
    const quotedKey = `"${"Violentmonkey:xWD1Be9nJAY="}"`; // Accessing document.cookie may throw due to CSP sandbox
...
const INIT_FUNC_NAME = "Violentmonkey:xWD1Be9nJAY=";
