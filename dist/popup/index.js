    ...
    "div",
    {
      ...
      on: {
        ...
        "!mouseenter": function($event) {
          return _vm.delegateMouseEnter($event)
        },
        "!mouseleave": function($event) {
          return _vm.delegateMouseLeave($event)
        },
              ...
              ? _c("a", {
                  ...
                  on: {
                    click: function($event) {
                      ...
                      return _vm.onInjectionFailureFix($event)
                    }
                  }
                })
              : _vm._e()
      ...
      _c("footer", [
        _c("a", {
          ...
          on: {
            click: function($event) {
              $event.preventDefault()
              return _vm.onVisitWebsite($event)
            }
          }
        })
      ]),
